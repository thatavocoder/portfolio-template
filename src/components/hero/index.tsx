...
const Hero = () => {
  return (
    <div className='min-h-screen' id="home">
      <Image src='/hero-bg2.jpeg' className='z-0 absolute opacity-5 object-cover object-center' fill alt="" />
      <div className='max-w-[1440px] 2xl:m-auto'>
        <div className='fixed w-full max-w-[1440px] flex flex-row justify-between xsm:px-4 md:px-6 xsm:py-1 md:py-2 z-10'>
          ...
          <div className='flex'>
            <FaGithub className='text-primary-500 xsm:text-xl md:text-2xl ml-4' />
            <FaLinkedinIn className='text-primary-500 xsm:text-xl md:text-2xl ml-4' />
            <MdEmail className='text-primary-500 xsm:text-xl md:text-2xl ml-4' />
          </div>
        </div>
